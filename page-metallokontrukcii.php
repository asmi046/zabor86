...
?>
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1 class="page-head__title">Металлоконтрукции</h1>
        </div>
      </div>
      <main role="main">
...
<?php 
$query = new WP_Query( 'taxonomy=category&post_type=services&category__in=4&nopaging=1&orderby=title&order=ASC' ); 
if( $query->have_posts() ){
...
?>
            ...
            <h4>ЦЕНЫ НА МЕТАЛЛОКОНСТРУКЦИИ</h4>
            <table class="table">
              <thead class="table__header">
                <tr>
                  <th>Вид металлоконструкций</th>
